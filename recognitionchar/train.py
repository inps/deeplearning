...
tf.app.flags.DEFINE_integer('max_steps', 7010, 'the max training steps ')
...
#tf.app.flags.DEFINE_string('mode', 'validation', 'the run mode')
...
def validation():
    ...
    #            logger.info('labels  {0} out_final {1}  accuracy {2}'.format(endpoints['labels'], endpoints['out_final'], endpoints['accuracy']))
